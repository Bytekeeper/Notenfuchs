...
class HalfYearGradeDisplayServiceTest {
    ...
    void tendencySuffix_exactMatch_isAlwaysPlain_evenAtZeroThreshold() {
        assertEquals("", service.tendencySuffix(new BigDecimal("3.0"), 3, BigDecimal.ZERO, deScale()));
    }

    @Test
    void tendencySuffix_withinThreshold_isPlain() {
        // 3.1 is exactly 0.10 above 3 - inclusive boundary.
        assertEquals("", service.tendencySuffix(new BigDecimal("3.1"), 3, new BigDecimal("0.10"), deScale()));
        assertEquals("", service.tendencySuffix(new BigDecimal("2.9"), 3, new BigDecimal("0.10"), deScale()));
    }
    ...
    void tendencySuffix_lowerIsBetter_leaningTowardLowerNumber_isPlus() {
        ...
        assertEquals("+", service.tendencySuffix(new BigDecimal("2.8"), 3, new BigDecimal("0.10"), deScale()));
    }
    ...
    void tendencySuffix_lowerIsBetter_leaningTowardHigherNumber_isMinus() {
        ...
        assertEquals("-", service.tendencySuffix(new BigDecimal("3.2"), 3, new BigDecimal("0.10"), deScale()));
    }
    ...
    void tendencySuffix_higherIsBetter_directionIsFlipped() {
        ...
        assertEquals("+", service.tendencySuffix(new BigDecimal("9.2"), 9, new BigDecimal("0.10"), pointsScaleHigherIsBetter()));
        assertEquals("-", service.tendencySuffix(new BigDecimal("8.8"), 9, new BigDecimal("0.10"), pointsScaleHigherIsBetter()));
    }

    @Test
    void tendencySuffix_zeroThreshold_anyDeviationGetsASuffix() {
        assertEquals("-", service.tendencySuffix(new BigDecimal("3.01"), 3, BigDecimal.ZERO, deScale()));
        assertEquals("+", service.tendencySuffix(new BigDecimal("2.99"), 3, BigDecimal.ZERO, deScale()));
    }
    ...
    void label_noGradesYet_isNull() {
        assertNull(service.label(null, null, HalfYearGradeDisplay.WHOLE, new BigDecimal("0.10"), deScale()));
    }
    ...
    void label_whole_withTendency_appendsSuffix() {
        assertEquals("3-", service.label(new BigDecimal("3.2"), 3, HalfYearGradeDisplay.WHOLE, new BigDecimal("0.10"), deScale()));
        assertEquals("3+", service.label(new BigDecimal("2.8"), 3, HalfYearGradeDisplay.WHOLE, new BigDecimal("0.10"), deScale()));
        assertEquals("3", service.label(new BigDecimal("3.0"), 3, HalfYearGradeDisplay.WHOLE, new BigDecimal("0.10"), deScale()));
    }
    ...
    /**
     * The worked example this feature is built from: with a 0.10 threshold, HALF reuses WHOLE's
    ...
    void label_half_withTendency_refinesSuffixIntoNeighboringHalfGrade() {
        ...
        assertEquals("2", service.label(new BigDecimal("2.1"), 2, HalfYearGradeDisplay.HALF, threshold, deScale()));
        assertEquals("2-", service.label(new BigDecimal("2.2"), 2, HalfYearGradeDisplay.HALF, threshold, deScale()));
        assertEquals("2-", service.label(new BigDecimal("2.3"), 2, HalfYearGradeDisplay.HALF, threshold, deScale()));
        assertEquals("2.5", service.label(new BigDecimal("2.4"), 2, HalfYearGradeDisplay.HALF, threshold, deScale()));
        assertEquals("2.5", service.label(new BigDecimal("2.5"), 2, HalfYearGradeDisplay.HALF, threshold, deScale()));
    }
    ...
    void label_half_withTendency_refinesSuffixIntoNeighboringHalfGrade_fromAbove() {
        BigDecimal threshold = new BigDecimal("0.10");
        assertEquals("3.5", service.label(new BigDecimal("3.6"), 4, HalfYearGradeDisplay.HALF, threshold, deScale()));
        assertEquals("4+", service.label(new BigDecimal("3.8"), 4, HalfYearGradeDisplay.HALF, threshold, deScale()));
    }
    ...
    void label_half_withTendency_exactTieConvergesRegardlessOfFinalGradeTieBreak() {
        BigDecimal threshold = new BigDecimal("0.10");
        assertEquals("2.5", service.label(new BigDecimal("2.5"), 2, HalfYearGradeDisplay.HALF, threshold, deScale()));
        assertEquals("2.5", service.label(new BigDecimal("2.5"), 3, HalfYearGradeDisplay.HALF, threshold, deScale()));
    }

    @Test
    void label_half_withTendency_higherIsBetter_directionIsFlipped() {
        assertEquals("9.5", service.label(new BigDecimal("9.45"), 9, HalfYearGradeDisplay.HALF, new BigDecimal("0.10"), pointsScaleHigherIsBetter()));
    }
}
